...
*TLDR: I cracked a software by messing with its assembly code. Here is a story -includiong technical details- of how I did it.*
...
The next step was to find the executable associated with the software. Since I own a Mac, the structure of any application is kinda standard: the executable usually hides in `/Applications/X/X.app/Conents/MacOS/X`
