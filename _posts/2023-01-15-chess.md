...
2. You will take one month to work on their bot.
...
4. The tournament will take place on `2023-02-21` live and you will be able to attend through Google Meet or in person.
...
It's simple: each bot will play every other bot in 3 games. If it wins a game, it gets 1 point. If it loses or draws, it doesn't get any points. The bot with the highest points wins.