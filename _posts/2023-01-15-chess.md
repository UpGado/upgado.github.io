...
class BotInterface:
    ...
    # This method should return a chess.Move object which represents a valid move that can be played.
    # Note: if an invalid/impossible move is returned, the bot loses. Make sure you always return a valid move.
    def next_move(self):
       pass
```