...
The answer is a bold **YES**. After all, let's not forget that the main reason programmers try to write good code is simply to improve productivity. Of course, scientists care about their productivity too (results, results, results!). However, since they are so focused on the science, they don't realize how much time they could save if they invest in writing good code for their data analysis. Scientists don't realize that their code could be so much better, for their own benefit. These benefits include the traditional benefits that affect any programmer: code that is more pleasing to the eye, and a clear, modular design that does not make you want to pull your hair. It also includes saving literal tens of hundreds of hours of human time: time that could be spent on something more productive that a computer couldn't do by itself.

## The problem with scientists' mindset
