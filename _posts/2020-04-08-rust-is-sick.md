...
To conclude, I really do not see anymore why I would pick C over Rust for systems programming use cases. C just feels very ancient compared to Rust's. If you like to use a language that has type inference, a great package manger, and a great compiler that offers native speed runtime, give Rust as shot.
