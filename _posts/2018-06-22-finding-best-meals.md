...
The number of cases gets higher faster and faster. So, we really can't use brute force for a big number of products unless we want to wait for eternity before picking a meal! For our case though, it is perfectly okay, even badass I think 😈, to use brute force. Let's go ahead and see how long it takes for different numbers of products.