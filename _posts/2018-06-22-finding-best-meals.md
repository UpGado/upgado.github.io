...
The number of cases gets higher faster and faster. So, we really can't use brute force for a big number of products unless we want to wait for eternity before picking a meal! For our case though, it is perfectly okay, even badass I think, to use brute force 😈. Our program is now all figured out, just need to put it into code, where I did! If you'd like to test it (or better yet improve it), you can find it [here](www.google.com).
